	...
	getThermostats: function() {
		var devices = [{ 
				...
				capabilities: [
					...
					'measure_temperature',
					'thermostat_mode',
					{ "id": "flame_on", "type": "boolean", "gettable": true, "settable": false },
					{ "id": "heating_on", "type": "boolean", "gettable": true, "settable": false },
					{ "id": "cooling_on", "type": "boolean", "gettable": true, "settable": false },
					{ "id": "heating_water", "type": "boolean", "gettable": true, "settable": false },
					{ "id": "fault", "type": "boolean", "gettable": true, "settable": false }
				]
			}];
		if (msg_supported[23]) {
			devices[1] = { 
