var otMsg = {
	StatusFlags: { // OpenTherm status flags [ID 0: Master status (HB) & Slave status (LB)]
		...
		'0x4000': { en: "Domestic hot water blocking", var: "StatusDHWBlocked" },
		'0x0001': { en: "Fault indication", var: "StatusFault" }, // no fault/fault
		'0x0002': { en: "Central heating mode", var: "StatusCHMode" }, // not active/active
		'0x0004': { en: "Domestic hot water mode", var: "StatusDHWMode" }, // not active/active
		'0x0008': { en: "Flame status", var: "StatusFlame" }, // flame off/on
		'0x0010': { en: "Cooling status", var: "StatusCooling" }, // not active/active
		'0x0020': { en: "Central heating 2 mode", var: "StatusCH2Mode" }, // not active/active
		'0x0040': { en: "Diagnostic indication", var: "StatusDiagnostic" } // no diagnostics/diagnostics event
	},
