var otMsg = {
	...
	'Messages': { // OpenTherm messages
		'0': { 'dir': "R-", 'txt': "Status", 'val': "flag8", 'flags': "StatusFlags" },
		'1': { 'dir': "-W", 'txt': "Control setpoint", 'val': "f8.8", 'var': "ControlSetpoint", 'sensor': "temperature" },
		'2': { 'dir': "-W", 'txt': "Master configuration", 'val': { 'hb': "flag8", 'lb': "u8" }, 'flags': "MasterConfigFlags", 'var': { 'lb': "MasterMemberId" } },
		'3': { 'dir': "R-", 'txt': "Slave configuration", 'val': { 'hb': "flag8", 'lb': "u8" }, 'flags': "SlaveConfigFlags", 'var': { 'lb': "SlaveMemberId" } },
		'4': { 'dir': "-W", 'txt': "Remote command", 'val': "u8", 'var': "RemoteCommand" },
		'5': { 'dir': "R-", 'txt': "Fault flags & OEM fault code", 'val': { 'hb': "flag8", 'lb': "u8" }, 'var': { 'lb': "FaultCode" }, 'flags': "FaultFlags" },
		'6': { 'dir': "R-", 'txt': "Remote parameter flags", 'val': "flag8", 'flags': "RemoteFlags" },
		'7': { 'dir': "-W", 'txt': "Cooling control signal", 'val': "f8.8", 'var': "CoolingControlSignal", 'sensor': "percentage" },
		'8': { 'dir': "-W", 'txt': "Control setpoint central heating 2", 'val': "f8.8", 'var': "CH2ControlSetpoint", 'sensor': "temperature" },
		'9': { 'dir': "R-", 'txt': "Remote override room setpoint", 'val': "f8.8", 'var': "RemoteOverrideRoomSetpoint", 'sensor': "temperature" },
		...
		'14': { 'dir': "-W", 'txt': "Max. relative modulation level", 'val': "f8.8", 'var': "MaxRelativeModulationLevel", 'sensor': "percentage" },
		'15': { 'dir': "R-", 'txt': "Max. boiler capacity (kW) and modulation level setting (%)", 'val': "u8", 'var': { 'hb': "MaxBoilerCapacity", 'lb': "MinModulationLevel" } },
		'16': { 'dir': "-W", 'txt': "Room setpoint", 'val': "f8.8", 'var': "CurrentSetpoint", 'sensor': "temperature" },
		'17': { 'dir': "R-", 'txt': "Relative modulation level", 'val': "f8.8", 'var': "RelativeModulationLevel", 'sensor': "percentage" },
		'18': { 'dir': "R-", 'txt': "Central heating water pressure", 'val': "f8.8", 'var': "CHWaterPressure", 'sensor': "pressure" },
		'19': { 'dir': "R-", 'txt': "Domestic hot water flow rate (litres/minute)", 'val': "f8.8", 'var': "DHWFlowRate", 'sensor': "flow" },
		'20': { 'dir': "RW", 'txt': "Day of week & time of day", 'var': "DayTime" },
		'21': { 'dir': "RW", 'txt': "Date", 'val': "u8", 'var': "Date" },
		'22': { 'dir': "RW", 'txt': "Year", 'val': "u16", 'var': "Year" },
		'23': { 'dir': "-W", 'txt': "Room setpoint central heating 2", 'val': "f8.8", 'var': "CH2CurrentSetpoint", 'sensor': "temperature" },
		'24': { 'dir': "-W", 'txt': "Room temperature", 'val': "f8.8", 'var': "CurrentTemperature", 'sensor': "temperature" },
		'25': { 'dir': "R-", 'txt': "Boiler water temperature", 'val': "f8.8", 'var': "BoilerWaterTemperature", 'sensor': "temperature" },
		'26': { 'dir': "R-", 'txt': "Domestic hot water temperature", 'val': "f8.8", 'var': "DHWTemperature", 'sensor': "temperature" },
		'27': { 'dir': "R-", 'txt': "Outside temperature", 'val': "f8.8", 'var': "OutsideTemperature", 'sensor': "temperature" },
		'28': { 'dir': "R-", 'txt': "Return water temperature", 'val': "f8.8", 'var': "ReturnWaterTemperature", 'sensor': "temperature" },
		'29': { 'dir': "R-", 'txt': "Solar storage temperature", 'val': "f8.8", 'var': "SolarStorageTemperature", 'sensor': "temperature" },
		'30': { 'dir': "R-", 'txt': "Solar collector temperature", 'val': "f8.8", 'var': "SolarCollectorTemperature", 'sensor': "temperature" },
		'31': { 'dir': "R-", 'txt': "Flow temperature central heating 2", 'val': "f8.8", 'var': "CH2FlowTemperature", 'sensor': "temperature" },
		'32': { 'dir': "R-", 'txt': "Domestic hot water 2 temperature", 'val': "f8.8", 'var': "DHW2Temperature", 'sensor': "temperature" },
		'33': { 'dir': "R-", 'txt': "Boiler exhaust temperature", 'val': "s16", 'var': "BoilerExhaustTemperature", 'sensor': "temperature" },
		'48': { 'dir': "R-", 'txt': "Domestic hot water setpoint boundaries", 'val': "s8", 'var': "DHWBounadries", 'sensor': "temperature" },
		'49': { 'dir': "R-", 'txt': "Max. central heating setpoint boundaries", 'val': "s8", 'var': "CHBoundaries", 'sensor': "temperature" },
		'50': { 'dir': "R-", 'txt': "OTC heat curve ratio upper & lower bounds", 'val': "s8", 'var': "OTCBoundaries" },
		'56': { 'dir': "RW", 'txt': "Domestic hot water setpoint", 'val': "f8.8", 'var': "DHWSetpoint", 'sensor': "temperature" },
		'57': { 'dir': "RW", 'txt': "Max. central heating water setpoint", 'val': "f8.8", 'var': "MaxCHWaterSetpoint", 'sensor': "temperature" },
		'58': { 'dir': "RW", 'txt': "OTC heat curve ratio", 'val': "f8.8", 'var': "OTCHeatCurveRatio", 'sensor': "temperature" },
		...
		'77': { 'dir': "R-", 'txt': "Relative ventilation", 'val': "u8", 'var': { 'hb': "RelativeVentilation" } },
		'78': { 'dir': "RW", 'txt': "Relative humidity", 'val': "u8", 'var': { 'hb': "RelativeHumidity" }, 'sensor': "humidity" },
		'79': { 'dir': "RW", 'txt': "CO2 level", 'val': "u16", 'var': "CO2Level", 'sensor': "co2" },
		'80': { 'dir': "R-", 'txt': "Supply inlet temperature", 'val': "f8.8", 'var': "SupplyInletTemperature", 'sensor': "temperature" },
		'81': { 'dir': "R-", 'txt': "Supply outlet temperature", 'val': "f8.8", 'var': "SupplyOutletTemperature", 'sensor': "temperature" },
		'82': { 'dir': "R-", 'txt': "Exhaust inlet temperature", 'val': "f8.8", 'var': "ExhaustInletTemperature", 'sensor': "temperature" },
		'83': { 'dir': "R-", 'txt': "Exhaust outlet temperature", 'val': "f8.8", 'var': "ExhaustOutletTemperature", 'sensor': "temperature" },
